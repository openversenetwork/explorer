...
function StakingComponent() {
    ...
    React.useEffect(() => {
        console.log('StakingComponent status', status);
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <h1>
                            ...
                            {/* <small>{lamportsToSolString(supply.circulating)}</small> */}
                        </h1>
                        <h5>
                            <em>{lamportsToSolString(supply.circulating, 0)}</em> is circulating
                        </h5>
                    </div>
                </div>
            </div>
            <div className="col-6 col-xl">
                <div className="card">
                    <div className="card-body">
                        ...
                        <h1>
                            <em>
                                <Link href={`/block/${blockHeight}`} className="font-monospace em">
                        ...
                        <h5>
                            Slot <em><Slot slot={absoluteSlot} /></em>
                        </h5>
                    </div>
                </div>
            </div>
