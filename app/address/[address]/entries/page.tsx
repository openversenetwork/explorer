...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return {
        description: `Entries of the address lookup table at ${props.params.address} on Openverse`,
        title: `Address Lookup Table Entries | ${await getReadableTitleFromAddress(props)} | Openverse`,
    };
}
