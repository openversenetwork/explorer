...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return {
        description: `History of all transactions involving the address ${props.params.address} on Openverse`,
        title: `Transaction History | ${await getReadableTitleFromAddress(props)} | Openverse`,
    };
}
