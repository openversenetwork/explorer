...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return {
        description: `NFToken NFTs belonging to the collection ${props.params.address} on Openverse`,
        title: `NFToken Collection NFTs | ${await getReadableTitleFromAddress(props)} | Openverse`,
    };
}
